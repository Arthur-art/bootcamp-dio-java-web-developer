...
public class ContatoOrdination {
    ...
    public static void main(String[] args) {
        ...
        /*Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(new Comparator<Map.Entry<Integer, Contato>>() {
            @Override
            public int compare(Map.Entry<Integer, Contato> telefone1, Map.Entry<Integer, Contato> telefone2) {
                return Integer.compare(telefone1.getValue().getNumero(),telefone2.getValue().getNumero());
            }
        });*/
        ...
        System.out.println("Valores organizados pelo numero: "+set);
